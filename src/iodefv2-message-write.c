...
/* Auto-generated by the iodefv2-message-write.c.mako template */
...
int iodefv2_telephone_write(iodefv2_telephone_t *telephone, libiodefv2_io_t *fd)
{
        ...
        {
                libiodefv2_string_t *description = NULL;
                
                
                while ( (description = iodefv2_telephone_get_next_description(telephone, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_TELEPHONE_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_certificate_write(iodefv2_certificate_t *certificate, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (description = iodefv2_certificate_get_next_description(certificate, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_CERTIFICATE_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_contact_write(iodefv2_contact_t *, libiodefv2_io_t *);
...
/**
 * iodefv2_extension_write:
 * @extension: Pointer to a #iodefv2_extension_t object.
 * @msg: Pointer to a #libiodefv2_msgbuf_t object, where the message should be written.
 *
 * Write @extension within @msg message buffer. The buffer is
 * associated with a #libiodefv2_io_t file descriptor where the data will be written.
 *
 * Returns: 0 on success, a negative value if an error occured.
 */
int iodefv2_extension_write(iodefv2_extension_t *extension, libiodefv2_io_t *fd)
{
        int ret;
        if ( ! extension )
            return 0;
            
        ret = binary_write(fd,  IODEFV2_MSG_EXTENSION_TAG, 0, NULL);
        if ( ret < 0 )
                return ret;

        {
                iodefv2_extension_restriction_t *tmp;

                tmp = iodefv2_extension_get_restriction(extension);
                if ( tmp ) {
                        ret = uint32_write(*tmp, fd, IODEFV2_MSG_EXTENSION_RESTRICTION);
                        if ( ret < 0 )
                                return ret;
                }
        }      
        ...
        ret = libiodefv2_string_write(iodefv2_extension_get_name(extension), fd, IODEFV2_MSG_EXTENSION_NAME);
        if ( ret < 0 )
                return ret;                
        

        ret = uint32_write(iodefv2_extension_get_dtype(extension), fd, IODEFV2_MSG_EXTENSION_DTYPE);
        if ( ret < 0 )
                return ret;
        

        ret = libiodefv2_string_write(iodefv2_extension_get_ext_restriction(extension), fd, IODEFV2_MSG_EXTENSION_EXT_RESTRICTION);
        if ( ret < 0 )
                return ret;                
        

        ret = libiodefv2_string_write(iodefv2_extension_get_meaning(extension), fd, IODEFV2_MSG_EXTENSION_MEANING);
        if ( ret < 0 )
                return ret;                
        

        ret = libiodefv2_string_write(iodefv2_extension_get_observable_id(extension), fd, IODEFV2_MSG_EXTENSION_OBSERVABLE_ID);
        if ( ret < 0 )
                return ret;                
        

        ret = libiodefv2_string_write(iodefv2_extension_get_formatid(extension), fd, IODEFV2_MSG_EXTENSION_FORMATID);
        if ( ret < 0 )
                return ret;                
        

        ret = libiodefv2_string_write(iodefv2_extension_get_ext_dtype(extension), fd, IODEFV2_MSG_EXTENSION_EXT_DTYPE);
        if ( ret < 0 )
                return ret;                
...
int iodefv2_reference_write(iodefv2_reference_t *reference, libiodefv2_io_t *fd)
{
        ...
        {
                libiodefv2_string_t *url = NULL;
                
                
                while ( (url = iodefv2_reference_get_next_url(reference, url)) ) {
                        ret = libiodefv2_string_write(url, fd, IODEFV2_MSG_REFERENCE_URL );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                ...
                while ( (description = iodefv2_reference_get_next_description(reference, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_REFERENCE_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_postal_address_write(iodefv2_postal_address_t *postal_address, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (description = iodefv2_postal_address_get_next_description(postal_address, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_POSTAL_ADDRESS_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_address_write(iodefv2_address_t *, libiodefv2_io_t *);
...
int iodefv2_node_role_write(iodefv2_node_role_t *node_role, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (description = iodefv2_node_role_get_next_description(node_role, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_NODE_ROLE_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_detection_pattern_write(iodefv2_detection_pattern_t *, libiodefv2_io_t *);
...
int iodefv2_system_impact_write(iodefv2_system_impact_t *system_impact, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (description = iodefv2_system_impact_get_next_description(system_impact, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_SYSTEM_IMPACT_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_discovery_write(iodefv2_discovery_t *discovery, libiodefv2_io_t *fd)
{
        ...
        }
        {
                ...
                while ( (description = iodefv2_discovery_get_next_description(discovery, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_DISCOVERY_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_business_impact_write(iodefv2_business_impact_t *business_impact, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (description = iodefv2_business_impact_get_next_description(business_impact, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_BUSINESS_IMPACT_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_email_write(iodefv2_email_t *email, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (description = iodefv2_email_get_next_description(email, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_EMAIL_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_service_name_write(iodefv2_service_name_t *service_name, libiodefv2_io_t *fd)
{
                ...
                return ret;
        {
                ...
                while ( (url = iodefv2_service_name_get_next_url(service_name, url)) ) {
                        ret = libiodefv2_string_write(url, fd, IODEFV2_MSG_SERVICE_NAME_URL );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        ...
        
        {
                ...
                while ( (description = iodefv2_service_name_get_next_description(service_name, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_SERVICE_NAME_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_intended_impact_write(iodefv2_intended_impact_t *intended_impact, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (description = iodefv2_intended_impact_get_next_description(intended_impact, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_INTENDED_IMPACT_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_signature_data_write(iodefv2_signature_data_t *signature_data, libiodefv2_io_t *fd)
{
        ...
        if ( ret < 0 )
                return ret;
        {
                libiodefv2_string_t *signature = NULL;
                
                
                while ( (signature = iodefv2_signature_data_get_next_signature(signature_data, signature)) ) {
                        ret = libiodefv2_string_write(signature, fd, IODEFV2_MSG_SIGNATURE_DATA_SIGNATURE );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_application_header_field_write(iodefv2_application_header_field_t *, libiodefv2_io_t *);
...
int iodefv2_expectation_write(iodefv2_expectation_t *expectation, libiodefv2_io_t *fd)
{
        ...
        {
                libiodefv2_string_t *defined_coa = NULL;
                
                
                while ( (defined_coa = iodefv2_expectation_get_next_defined_coa(expectation, defined_coa)) ) {
                        ret = libiodefv2_string_write(defined_coa, fd, IODEFV2_MSG_EXPECTATION_DEFINED_COA );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                ...
                while ( (description = iodefv2_expectation_get_next_description(expectation, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_EXPECTATION_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_application_header_write(iodefv2_application_header_t *application_header, libiodefv2_io_t *fd)
{
        ...
        if ( ret < 0 )
                return ret;
        {
                iodefv2_application_header_field_t *application_header_field = NULL;
                
                
                while ( (application_header_field = iodefv2_application_header_get_next_application_header_field(application_header, application_header_field)) ) {
                        ret = iodefv2_application_header_field_write(application_header_field, fd);
                        if ( ret < 0 )
                                return ret;                          
            }
        }
...
int iodefv2_additional_data_write(iodefv2_additional_data_t *, libiodefv2_io_t *);
...
int iodefv2_history_item_write(iodefv2_history_item_t *history_item, libiodefv2_io_t *fd)
{
        ...
        }
        {
                ...
                while ( (defined_coa = iodefv2_history_item_get_next_defined_coa(history_item, defined_coa)) ) {
                        ret = libiodefv2_string_write(defined_coa, fd, IODEFV2_MSG_HISTORY_ITEM_DEFINED_COA );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                ...
                while ( (description = iodefv2_history_item_get_next_description(history_item, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_HISTORY_ITEM_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_method_write(iodefv2_method_t *method, libiodefv2_io_t *fd)
{
        ...
        }
        {
                ...
                while ( (description = iodefv2_method_get_next_description(method, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_METHOD_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_related_dns_write(iodefv2_related_dns_t *, libiodefv2_io_t *);
...
int iodefv2_campaign_write(iodefv2_campaign_t *campaign, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (url = iodefv2_campaign_get_next_url(campaign, url)) ) {
                        ret = libiodefv2_string_write(url, fd, IODEFV2_MSG_CAMPAIGN_URL );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        ...
        }
        {
                ...
                while ( (description = iodefv2_campaign_get_next_description(campaign, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_CAMPAIGN_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                libiodefv2_string_t *campaign_id = NULL;
                
                
                while ( (campaign_id = iodefv2_campaign_get_next_campaign_id(campaign, campaign_id)) ) {
                        ret = libiodefv2_string_write(campaign_id, fd, IODEFV2_MSG_CAMPAIGN_CAMPAIGN_ID );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_domain_data_write(iodefv2_domain_data_t *domain_data, libiodefv2_io_t *fd)
{
        ...
        {
                iodefv2_related_dns_t *related_dns = NULL;
                
                
                while ( (related_dns = iodefv2_domain_data_get_next_related_dns(domain_data, related_dns)) ) {
                        ret = iodefv2_related_dns_write(related_dns, fd);
                        if ( ret < 0 )
                                return ret;                          
            }
        }
...
int iodefv2_contact_write(iodefv2_contact_t *contact, libiodefv2_io_t *fd)
{
        ...
        {
                libiodefv2_string_t *contact_title = NULL;
                
                
                while ( (contact_title = iodefv2_contact_get_next_contact_title(contact, contact_title)) ) {
                        ret = libiodefv2_string_write(contact_title, fd, IODEFV2_MSG_CONTACT_CONTACT_TITLE );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                ...
                while ( (description = iodefv2_contact_get_next_description(contact, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_CONTACT_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        ...
        }
        {
                ...
                while ( (contact = iodefv2_contact_get_next_contact(contact, contact)) ) {
                        ret = iodefv2_contact_write(contact, fd);
                        if ( ret < 0 )
                                return ret;                          
            }
        ...
        {
                libiodefv2_string_t *contact_name = NULL;
                
                
                while ( (contact_name = iodefv2_contact_get_next_contact_name(contact, contact_name)) ) {
                        ret = libiodefv2_string_write(contact_name, fd, IODEFV2_MSG_CONTACT_CONTACT_NAME );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_assessment_write(iodefv2_assessment_t *assessment, libiodefv2_io_t *fd)
{
        ...
        {
                libiodefv2_string_t *incident_category = NULL;
                
                
                while ( (incident_category = iodefv2_assessment_get_next_incident_category(assessment, incident_category)) ) {
                        ret = libiodefv2_string_write(incident_category, fd, IODEFV2_MSG_ASSESSMENT_INCIDENT_CATEGORY );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                libiodefv2_string_t *mitigating_factor = NULL;
                
                
                while ( (mitigating_factor = iodefv2_assessment_get_next_mitigating_factor(assessment, mitigating_factor)) ) {
                        ret = libiodefv2_string_write(mitigating_factor, fd, IODEFV2_MSG_ASSESSMENT_MITIGATING_FACTOR );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                libiodefv2_string_t *cause = NULL;
                
                
                while ( (cause = iodefv2_assessment_get_next_cause(assessment, cause)) ) {
                        ret = libiodefv2_string_write(cause, fd, IODEFV2_MSG_ASSESSMENT_CAUSE );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_threat_actor_write(iodefv2_threat_actor_t *threat_actor, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (url = iodefv2_threat_actor_get_next_url(threat_actor, url)) ) {
                        ret = libiodefv2_string_write(url, fd, IODEFV2_MSG_THREAT_ACTOR_URL );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                libiodefv2_string_t *threat_actor_id = NULL;
                
                
                while ( (threat_actor_id = iodefv2_threat_actor_get_next_threat_actor_id(threat_actor, threat_actor_id)) ) {
                        ret = libiodefv2_string_write(threat_actor_id, fd, IODEFV2_MSG_THREAT_ACTOR_THREAT_ACTOR_ID );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                ...
                while ( (description = iodefv2_threat_actor_get_next_description(threat_actor, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_THREAT_ACTOR_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_related_activity_write(iodefv2_related_activity_t *related_activity, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (description = iodefv2_related_activity_get_next_description(related_activity, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_RELATED_ACTIVITY_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        ...
        }
        {
                ...
                while ( (url = iodefv2_related_activity_get_next_url(related_activity, url)) ) {
                        ret = libiodefv2_string_write(url, fd, IODEFV2_MSG_RELATED_ACTIVITY_URL );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_node_write(iodefv2_node_t *node, libiodefv2_io_t *fd)
{
        ...
        if ( ret < 0 )
                return ret;
        {
                libiodefv2_string_t *postal_address = NULL;
                
                
                while ( (postal_address = iodefv2_node_get_next_postal_address(node, postal_address)) ) {
                        ret = libiodefv2_string_write(postal_address, fd, IODEFV2_MSG_NODE_POSTAL_ADDRESS );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_application_write(iodefv2_application_t *, libiodefv2_io_t *);
...
int iodefv2_hash_write(iodefv2_hash_t *hash, libiodefv2_io_t *fd)
{
        ...
        if ( ret < 0 )
         ...
         ret = iodefv2_application_write(iodefv2_hash_get_application(hash), fd);
         if ( ret < 0 )
                return ret;              
...
int iodefv2_fuzzy_hash_value_write(iodefv2_fuzzy_hash_value_t *, libiodefv2_io_t *);
...
int iodefv2_detection_pattern_write(iodefv2_detection_pattern_t *detection_pattern, libiodefv2_io_t *fd)
{
        ...
        if ( ret < 0 )
         ...
         ret = iodefv2_application_write(iodefv2_detection_pattern_get_application(detection_pattern), fd);
         if ( ret < 0 )
                return ret;              
        
        {
                ...
                while ( (detection_pattern = iodefv2_detection_pattern_get_next_detection_pattern(detection_pattern, detection_pattern)) ) {
                        ret = iodefv2_detection_pattern_write(detection_pattern, fd);
                        if ( ret < 0 )
                                return ret;                          
            }
        }
        {
                ...
                while ( (description = iodefv2_detection_pattern_get_next_description(detection_pattern, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_DETECTION_PATTERN_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                libiodefv2_string_t *detection_configuration = NULL;
                
                
                while ( (detection_configuration = iodefv2_detection_pattern_get_next_detection_configuration(detection_pattern, detection_configuration)) ) {
                        ret = libiodefv2_string_write(detection_configuration, fd, IODEFV2_MSG_DETECTION_PATTERN_DETECTION_CONFIGURATION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
...
int iodefv2_fuzzy_hash_write(iodefv2_fuzzy_hash_t *fuzzy_hash, libiodefv2_io_t *fd)
{
        ...
        {
                iodefv2_fuzzy_hash_value_t *fuzzy_hash_value = NULL;
                
                
                while ( (fuzzy_hash_value = iodefv2_fuzzy_hash_get_next_fuzzy_hash_value(fuzzy_hash, fuzzy_hash_value)) ) {
                        ret = iodefv2_fuzzy_hash_value_write(fuzzy_hash_value, fd);
                        if ( ret < 0 )
                                return ret;                          
            }
        }
         ret = iodefv2_application_write(iodefv2_fuzzy_hash_get_application(fuzzy_hash), fd);
         if ( ret < 0 )
                return ret;              
...
int iodefv2_email_header_field_write(iodefv2_email_header_field_t *, libiodefv2_io_t *);


int iodefv2_associated_software_write(iodefv2_associated_software_t *, libiodefv2_io_t *);

int iodefv2_file_properties_write(iodefv2_file_properties_t *, libiodefv2_io_t *);
...
int iodefv2_email_data_write(iodefv2_email_data_t *email_data, libiodefv2_io_t *fd)
{
        ...
        {
                libiodefv2_string_t *email_to = NULL;
                
                
                while ( (email_to = iodefv2_email_data_get_next_email_to(email_data, email_to)) ) {
                        ret = libiodefv2_string_write(email_to, fd, IODEFV2_MSG_EMAIL_DATA_EMAIL_TO );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        ...
        {
                iodefv2_email_header_field_t *email_header_field = NULL;
                
                
                while ( (email_header_field = iodefv2_email_data_get_next_email_header_field(email_data, email_header_field)) ) {
                        ret = iodefv2_email_header_field_write(email_header_field, fd);
                        if ( ret < 0 )
                                return ret;                          
            }
        }
...
int iodefv2_file_write(iodefv2_file_t *file, libiodefv2_io_t *fd)
{
        ...
        if ( ret < 0 )
         ...
         ret = iodefv2_associated_software_write(iodefv2_file_get_associated_software(file), fd);
         if ( ret < 0 )
                return ret;              
        
        {
                ...
                while ( (url = iodefv2_file_get_next_url(file, url)) ) {
                        ret = libiodefv2_string_write(url, fd, IODEFV2_MSG_FILE_URL );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        ...
        {
                iodefv2_file_properties_t *file_properties = NULL;
                
                
                while ( (file_properties = iodefv2_file_get_next_file_properties(file, file_properties)) ) {
                        ret = iodefv2_file_properties_write(file_properties, fd);
                        if ( ret < 0 )
                                return ret;                          
            }
        }
...
int iodefv2_service_write(iodefv2_service_t *service, libiodefv2_io_t *fd)
{
        ...
        {
                iodefv2_application_t *application = NULL;
                
                
                while ( (application = iodefv2_service_get_next_application(service, application)) ) {
                        ret = iodefv2_application_write(application, fd);
                        if ( ret < 0 )
                                return ret;                          
            }
        }
...
int iodefv2_operating_system_write(iodefv2_operating_system_t *, libiodefv2_io_t *);
...
int iodefv2_record_item_write(iodefv2_record_item_t *, libiodefv2_io_t *);
...
int iodefv2_system_write(iodefv2_system_t *system, libiodefv2_io_t *fd)
{
        ...
        }
        {
                ...
                while ( (description = iodefv2_system_get_next_description(system, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_SYSTEM_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        ...
        {
                libiodefv2_string_t *asset_id = NULL;
                
                
                while ( (asset_id = iodefv2_system_get_next_asset_id(system, asset_id)) ) {
                        ret = libiodefv2_string_write(asset_id, fd, IODEFV2_MSG_SYSTEM_ASSET_ID );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        ...
        }
        {
         ...
         ret = iodefv2_operating_system_write(iodefv2_system_get_operating_system(system), fd);
         if ( ret < 0 )
                return ret;              
...
int iodefv2_event_data_write(iodefv2_event_data_t *, libiodefv2_io_t *);
...
int iodefv2_record_data_write(iodefv2_record_data_t *record_data, libiodefv2_io_t *fd)
{
        ...
        }
        {
                ...
                while ( (description = iodefv2_record_data_get_next_description(record_data, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_RECORD_DATA_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        {
                ...
                while ( (url = iodefv2_record_data_get_next_url(record_data, url)) ) {
                        ret = libiodefv2_string_write(url, fd, IODEFV2_MSG_RECORD_DATA_URL );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        ...
        
        {
         ...
         ret = iodefv2_application_write(iodefv2_record_data_get_application(record_data), fd);
         if ( ret < 0 )
                return ret;              
        
        {
                iodefv2_record_item_t *record_item = NULL;
                
                
                while ( (record_item = iodefv2_record_data_get_next_record_item(record_data, record_item)) ) {
                        ret = iodefv2_record_item_write(record_item, fd);
                        if ( ret < 0 )
                                return ret;                          
            }
        }
...
int iodefv2_event_data_write(iodefv2_event_data_t *event_data, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (description = iodefv2_event_data_get_next_description(event_data, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_EVENT_DATA_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
        ...
        
        {
                ...
                while ( (event_data = iodefv2_event_data_get_next_event_data(event_data, event_data)) ) {
...
int iodefv2_incident_write(iodefv2_incident_t *incident, libiodefv2_io_t *fd)
{
        ...
        
        {
                ...
                while ( (description = iodefv2_incident_get_next_description(incident, description)) ) {
                        ret = libiodefv2_string_write(description, fd, IODEFV2_MSG_INCIDENT_DESCRIPTION );
                        if ( ret < 0 )
                                return ret;                                
            }
        }
