        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "type") == 0 ) {
                        ...
                        ret = iodefv2_telephone_new_description(telephone, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "observable_id") == 0 ) {
                        ...
                        ret = iodefv2_certificate_new_description(certificate, &str);
                        if ( ret < 0 )
                                return ret;
...
static int iodefv2_record_pattern_read_json(iodefv2_record_pattern_t *record_pattern, json_data_t *ctrl)
{
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                else if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "offsetunit") == 0 ) {
                        ctrl->idx++;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "observable_id") == 0 ) {
                        ...
                        ret = iodefv2_reference_new_url(reference, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_reference_new_description(reference, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "type") == 0 ) {
                        ...
                        ret = iodefv2_postal_address_new_description(postal_address, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "category") == 0 ) {
                        ...
                        ret = iodefv2_node_role_new_description(node_role, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "completion") == 0 ) {
                        ...
                        ret = iodefv2_system_impact_new_description(system_impact, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "ext_severity") == 0 ) {
                        ...
                        ret = iodefv2_business_impact_new_description(business_impact, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "type") == 0 ) {
                        ...
                        ret = iodefv2_email_new_description(email, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "ext_severity") == 0 ) {
                        ...
                        ret = iodefv2_intended_impact_new_description(intended_impact, &str);
                        if ( ret < 0 )
                                return ret;
 ...
 * @json: Pointer to a #json_t object, containing a message.
 *
 * Read an iodefv2_additional_data from the @json message, and
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_additional_data_restriction_to_numeric(buf);
                        if ( ret != -1 )
                                iodefv2_additional_data_set_restriction(additional_data, ret);
                }
                        ...
                        ret = iodefv2_additional_data_new_name(additional_data, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_additional_data_type_to_numeric(buf);
                        if ( ret != -1 )
                                iodefv2_additional_data_set_type(additional_data, ret);
                }
                        ...
                        ret = iodefv2_additional_data_new_ext_restriction(additional_data, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_additional_data_new_formatid(additional_data, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_additional_data_new_observable_id(additional_data, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_additional_data_new_meaning(additional_data, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_additional_data_new_ext_dtype(additional_data, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        if ( ret < 0 )
                                return libiodefv2_error_verbose(LIBIODEFV2_ERROR_GENERIC, "type argument required for additional data object");
                        ...
                        type = iodefv2_additional_data_type_to_numeric(buf);
                        if ( type < 0 )
                                return type;

                        ret = iodefv2_additional_data_new_data(additional_data, &data);
                        if ( ret < 0 )
                                return ret;
                        switch(type) {
                                case IODEFV2_ADDITIONAL_DATA_TYPE_REAL:
                                {
                                        float val;
                                        ...
                                        iodefv2_data_set_float(data, val);
                                        break;
                                }
                                case IODEFV2_ADDITIONAL_DATA_TYPE_BOOLEAN:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_BYTE:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_CHARACTER:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_INTEGER:
                                {
                                        ...
                                        iodefv2_data_set_int(data, val);
                                        break;
                                }
                                case IODEFV2_ADDITIONAL_DATA_TYPE_DATE_TIME:
                                {
                                        iodefv2_time_t *time;
                                        char buf[128];
                                        ...
                                        iodefv2_data_set_time(data, time);
                                        break;
                                }
                                case IODEFV2_ADDITIONAL_DATA_TYPE_PORTLIST:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_STRING:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_PATH:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_URL:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_CSV:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_XML:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_NTPSTAMP:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_EXT_VALUE:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_FILE:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_FRAME:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_PACKET:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_IPV4_PACKET:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_IPV6_PACKET:
                                case IODEFV2_ADDITIONAL_DATA_TYPE_BYTES:
                                {
                                        libiodefv2_string_t *str;
                                        ...
                                        if ( type == IODEFV2_ADDITIONAL_DATA_TYPE_FILE || 
                                               ...
                                               IODEFV2_ADDITIONAL_DATA_TYPE_BYTES )
                                                ret = iodefv2_data_set_byte_string_dup(data, (const unsigned char *) libiodefv2_string_get_string(str), libiodefv2_string_get_len(str));
                                        else
                                                ret = iodefv2_data_set_char_string_dup_fast(data, libiodefv2_string_get_string(str), libiodefv2_string_get_len(str));
                        ...
                        return libiodefv2_error_verbose(LIBIODEFV2_ERROR_GENERIC, "unexpected field '%.*s' while reading additional_data", ctrl->jtok[ctrl->idx].end - ctrl->jtok[ctrl->idx].start, ctrl->input + ctrl->jtok[ctrl->idx].start);
                }
        }
...
static int iodefv2_counter_read_json(iodefv2_counter_t *counter, json_data_t *ctrl)
{
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                else if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "ext_unit") == 0 ) {
                        ctrl->idx++;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "url") == 0 ) {
                        ...
                        ret = iodefv2_service_name_new_url(service_name, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_service_name_new_description(service_name, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "signature") == 0 ) {
                        ...
                        ret = iodefv2_signature_data_new_signature(signature_data, &str);
                        if ( ret < 0 )
                                return ret;
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "additional_data") == 0 ) {
                        ...
                        if ( ctrl->jtok[ctrl->idx].type == JSMN_ARRAY) {
                                ...
                                for ( unsigned int j = 0; j < lsize; j++ ) {
                                                ...
                                                ret = iodefv2_application_header_new_additional_data(application_header, &additional_data, IODEFV2_LIST_APPEND);
                                                if ( ret < 0 )
                                                        return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_threat_actor_new_url(threat_actor, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_threat_actor_new_threat_actor_id(threat_actor, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_threat_actor_new_description(threat_actor, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_method_new_description(method, &str);
                        if ( ret < 0 )
                                return ret;
...
static int iodefv2_nameservers_read_json(iodefv2_nameservers_t *nameservers, json_data_t *ctrl)
{
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "address") == 0 ) {
                        ctrl->idx++;
                ...
                else if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "server") == 0 ) {
                        ctrl->idx++;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_campaign_new_url(campaign, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_campaign_new_description(campaign, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_campaign_new_campaign_id(campaign, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_assessment_new_incident_category(assessment, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_assessment_new_mitigating_factor(assessment, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_assessment_new_cause(assessment, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_contact_new_contact_title(contact, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_contact_new_description(contact, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_contact_new_contact_name(contact, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_related_activity_new_description(related_activity, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_related_activity_new_url(related_activity, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "action") == 0 ) {
                        ...
                        ret = iodefv2_history_item_new_defined_coa(history_item, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_history_item_new_description(history_item, &str);
                        if ( ret < 0 )
                                return ret;
...
static int iodefv2_fuzzy_hash_read_json(iodefv2_fuzzy_hash_t *fuzzy_hash, json_data_t *ctrl)
{
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "additional_data") == 0 ) {
                ...
                else if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "software") == 0 ) {
                        ctrl->idx++;
                        ...
                        ret = iodefv2_fuzzy_hash_new_software(fuzzy_hash, &software);
                        if ( ret < 0 )
                                return ret;

                        ret = iodefv2_software_read_json(software, ctrl);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "digest_value") == 0 ) {
                        ...
                        ret = iodefv2_hash_new_software(hash, &software);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_detection_pattern_new_detection_configuration(detection_pattern, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_detection_pattern_new_description(detection_pattern, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_detection_pattern_new_software(detection_pattern, &software);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_expectation_new_defined_coa(expectation, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_expectation_new_description(expectation, &str);
                        if ( ret < 0 )
                                return ret;
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "ext_domain_status") == 0 ) {
                        ...
                        if ( ctrl->jtok[ctrl->idx].type == JSMN_ARRAY) {
                                ...
                                for ( unsigned int j = 0; j < lsize; j++ ) {
                                                ...
                                                ret = iodefv2_domain_data_new_additional_data(domain_data, &additional_data, IODEFV2_LIST_APPEND);
                                                if ( ret < 0 )
                                                        return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "source") == 0 ) {
                        ...
                        ret = iodefv2_discovery_new_description(discovery, &str);
                        if ( ret < 0 )
                                return ret;
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "observable_id") == 0 ) {
                        ...
                        if ( ctrl->jtok[ctrl->idx].type == JSMN_ARRAY) {
                                ...
                                for ( unsigned int j = 0; j < lsize; j++ ) {
                                                ...
                                                ret = iodefv2_email_data_new_additional_data(email_data, &additional_data, IODEFV2_LIST_APPEND);
                                                if ( ret < 0 )
                                                        return ret;
                        ...
                        ret = iodefv2_email_data_new_email_to(email_data, &str);
                        if ( ret < 0 )
                                return ret;
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "observable_id") == 0 ) {
                        ...
                        if ( ctrl->jtok[ctrl->idx].type == JSMN_ARRAY) {
                                ...
                                for ( unsigned int j = 0; j < lsize; j++ ) {
                                                ...
                                                ret = iodefv2_file_new_additional_data(file, &additional_data, IODEFV2_LIST_APPEND);
                                                if ( ret < 0 )
                                                        return ret;
                        ...
                        ret = iodefv2_file_new_url(file, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_file_new_software(file, &software);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "postal_address") == 0 ) {
                        ...
                        ret = iodefv2_node_new_postal_address(node, &str);
                        if ( ret < 0 )
                                return ret;
...

                    {
                        ...
                        if ( ctrl->jtok[ctrl->idx].type == JSMN_ARRAY) {
                                ...
                                for ( unsigned int j = 0; j < lsize; j++ ) {
                                                ...
                                                ret = iodefv2_service_new_software(service, &software, IODEFV2_LIST_APPEND);
                                                if ( ret < 0 )
                                                        return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "category") == 0 ) {
                        ...
                        ret = iodefv2_system_new_description(system, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_system_new_asset_id(system, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_system_new_software(system, &software);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_record_data_new_description(record_data, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_record_data_new_url(record_data, &str);
                        if ( ret < 0 )
                                return ret;
                        ...
                        ret = iodefv2_record_data_new_software(record_data, &software);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "restriction") == 0 ) {
                        ...
                        ret = iodefv2_event_data_new_description(event_data, &str);
                        if ( ret < 0 )
                                return ret;
        ...
        for ( ctrl->idx += 1; i < size && ctrl->idx < ctrl->jtoksize; ctrl->idx++, i++ ) {
                ...
                if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "_self") == 0 ) {
                 ...
                 if ( jsoneq(ctrl, &ctrl->jtok[ctrl->idx], "status") == 0 ) {
                        ...
                        ret = iodefv2_incident_new_description(incident, &str);
                        if ( ret < 0 )
                                return ret;
...
int iodefv2_object_new_from_json(iodefv2_object_t **object, const char *json_message)
{
        ...
        if ( jsoneq(&ctrl, &ctrl.jtok[selfkey + 1], "iodefv2_additional_data_t") == 0 ) {
                ret = iodefv2_additional_data_new((iodefv2_additional_data_t **) object);
                if ( ret < 0 )
                        return ret;

                ret = iodefv2_additional_data_read_json((iodefv2_additional_data_t *) *object, &ctrl);
        }
        else
