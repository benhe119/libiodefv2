...
*
* Written by Yoann Vandoorselaere <yoann@libiodefv2-ids.org>
*
*****/

#ifndef _LIBIODEFV2_RULES_VARIABLE_H
#define _LIBIODEFV2_RULES_VARIABLE_H
...
#endif /* _LIBIODEFV2_RULES_VARIABLE_H */
