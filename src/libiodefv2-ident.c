...
static uint64_t get_current_time(libiodefv2_ident_t *ident)
{
        uint64_t now;
...
static void uuidgen(libiodefv2_ident_t *ident)
{
        uint64_t timestamp;
...
/**
 * libiodefv2_ident_generate:
 * @ident: Pointer to a #libiodefv2_ident_t object.
 * @out: #libiodefv2_string_t where the ident will be generated.
 *
...
int libiodefv2_ident_generate(libiodefv2_ident_t *ident, libiodefv2_string_t *out)
{
        ...
        return libiodefv2_string_sprintf(out, "%8.8x-%4.4x-%4.4x-%2.2x%2.2x",
...
/**
 * libiodefv2_ident_destroy:
 * @ident: Pointer to a #libiodefv2_ident_t object.
 *
 * Destroy a #libiodefv2_ident_t object.
 */
