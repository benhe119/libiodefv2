...
/* Auto-generated by the iodefv2-message-print-json.c.mako template */
...
int iodefv2_extension_print_json(iodefv2_extension_t *ptr, libiodefv2_io_t *fd)
{
        ...
        ret = do_write(fd, "{\"_self\": \"iodefv2_extension_t\"");
        if ( ret < 0 )
                return ret;

        {
                ...
                if ( i )
{
                        const char *enumstr = iodefv2_extension_restriction_to_string(*i);
...
{
                        const char *enumstr = iodefv2_extension_dtype_to_string(i);
                ...
                return ret;
{
                ...
                while ( (elem = iodefv2_application_header_get_next_application_header_field(ptr, elem)) ) {
                        if ( ! first )
                                ...
                                first = 0;
                                ret = do_write(fd, ", \"application_header_field\": [");
                        }

                        if ( ret < 0 )
                                return ret;
                        ret = iodefv2_application_header_field_print_json(elem, fd);
                        if ( ret < 0 )
                                return ret;
 }
        ...
        }
{
                ...
                while ( (elem = iodefv2_domain_data_get_next_related_dns(ptr, elem)) ) {
                        if ( ! first )
                                ...
                                first = 0;
                                ret = do_write(fd, ", \"related_dns\": [");
                        }

                        if ( ret < 0 )
                                return ret;
                        ret = iodefv2_related_dns_print_json(elem, fd);
                        if ( ret < 0 )
                                return ret;
 }
...

{
                ...
                if ( field ) {
                        ...
                        ret = iodefv2_application_print_json(field, fd);
                        if ( ret < 0 )
                                return ret;
                }
        }
        ...
        }
{
                ...
                while ( (elem = iodefv2_fuzzy_hash_get_next_fuzzy_hash_value(ptr, elem)) ) {
                        if ( ! first )
                                ...
                                first = 0;
                                ret = do_write(fd, ", \"fuzzy_hash_value\": [");
                        }

                        if ( ret < 0 )
                                return ret;
                        ret = iodefv2_fuzzy_hash_value_print_json(elem, fd);
                        if ( ret < 0 )
                                return ret;
 }
        ...
        }
{
                ...
                while ( (elem = iodefv2_email_data_get_next_email_header_field(ptr, elem)) ) {
                        if ( ! first )
                                ...
                                first = 0;
                                ret = do_write(fd, ", \"email_header_field\": [");
                        }

                        if ( ret < 0 )
                                return ret;
                        ret = iodefv2_email_header_field_print_json(elem, fd);
                        if ( ret < 0 )
                                return ret;
 }
...

{
                ...
                if ( field ) {
                        ret = do_write(fd, ", \"associated_software\": ");
                        if ( ret < 0 )
                                return ret;

                        ret = iodefv2_associated_software_print_json(field, fd);
                        if ( ret < 0 )
                                return ret;
                }
        }
        ...
        }
{
                ...
                while ( (elem = iodefv2_file_get_next_file_properties(ptr, elem)) ) {
                        if ( ! first )
                                ...
                                first = 0;
                                ret = do_write(fd, ", \"file_properties\": [");
                        }

                        if ( ret < 0 )
                                return ret;
                        ret = iodefv2_file_properties_print_json(elem, fd);
                        if ( ret < 0 )
                                return ret;
 }
        ...
        }
{
                ...
                while ( (elem = iodefv2_service_get_next_application(ptr, elem)) ) {
                        ...
                        if ( ret < 0 )
                                return ret;
                        ret = iodefv2_application_print_json(elem, fd);
                        if ( ret < 0 )
                                return ret;
 }
...

{
                ...
                if ( field ) {
                        ...
                        ret = iodefv2_operating_system_print_json(field, fd);
                        if ( ret < 0 )
                                return ret;
                }
        }
        ...
        }
{
                ...
                while ( (elem = iodefv2_record_data_get_next_record_item(ptr, elem)) ) {
                        ...
                        if ( ret < 0 )
                                return ret;
                        ret = iodefv2_record_item_print_json(elem, fd);
                        if ( ret < 0 )
                                return ret;
 }
