...
/* Auto-generated by the GenerateIODEFV2MessageReadC package */
#include "config.h"
...
static inline int libiodefv2_extract_time_safe(idmefv2_time_t **out, void *buf, size_t len, libiodefv2_msg_t *msg)
{
        int ret;
        ...
        idmefv2_time_set_sec(*out, libiodefv2_extract_uint32(buf));
        idmefv2_time_set_usec(*out, libiodefv2_extract_uint32((unsigned char *) buf + 4));
        idmefv2_time_set_gmt_offset(*out, libiodefv2_extract_int32((unsigned char *) buf + 8));

        return 0;
}


static inline int libiodefv2_extract_data_safe(idmefv2_data_t **out, void *buf, uint32_t len, libiodefv2_msg_t *msg)
{
        int ret;
        uint8_t tag;
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_TELEPHONE_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_telephone_set_description(telephone, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_CERTIFICATE_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_certificate_set_description(certificate, tmp, -1);
                                break;
                        }
 ...
 * @msg: Pointer to a #libiodefv2_msg_t object, containing a message.
 *
 * Read an iodefv2_extension from the @msg message, and
...
int iodefv2_extension_read(iodefv2_extension_t *extension, libiodefv2_msg_t *msg)
{
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_EXTENSION_RESTRICTION : {
                                int32_t tmp = 0;

                                ret = libiodefv2_extract_int32_safe(&tmp, buf, len);
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_extension_set_restriction(extension, tmp);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_EXTENSION_NAME : {
                                libiodefv2_string_t *tmp = NULL;

                                ret = libiodefv2_extract_string_safe(&tmp, buf, len, msg);
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_extension_set_name(extension, tmp);
                                break;
                        }
          

                        case IODEFV2_MSG_EXTENSION_DTYPE : {
                                int32_t tmp = 0;

                                ret = libiodefv2_extract_int32_safe(&tmp, buf, len);
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_extension_set_dtype(extension, tmp);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_EXTENSION_EXT_RESTRICTION : {
                                libiodefv2_string_t *tmp = NULL;

                                ret = libiodefv2_extract_string_safe(&tmp, buf, len, msg);
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_extension_set_ext_restriction(extension, tmp);
                                break;
                        }
          


                        case IODEFV2_MSG_EXTENSION_MEANING : {
                                libiodefv2_string_t *tmp = NULL;

                                ret = libiodefv2_extract_string_safe(&tmp, buf, len, msg);
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_extension_set_meaning(extension, tmp);
                                break;
                        }
          


                        case IODEFV2_MSG_EXTENSION_OBSERVABLE_ID : {
                                libiodefv2_string_t *tmp = NULL;

                                ret = libiodefv2_extract_string_safe(&tmp, buf, len, msg);
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_extension_set_observable_id(extension, tmp);
                                break;
                        }
          


                        case IODEFV2_MSG_EXTENSION_FORMATID : {
                                libiodefv2_string_t *tmp = NULL;

                                ret = libiodefv2_extract_string_safe(&tmp, buf, len, msg);
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_extension_set_formatid(extension, tmp);
                                break;
                        }
          


                        case IODEFV2_MSG_EXTENSION_EXT_DTYPE : {
                                libiodefv2_string_t *tmp = NULL;

                                ret = libiodefv2_extract_string_safe(&tmp, buf, len, msg);
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_extension_set_ext_dtype(extension, tmp);
                                break;
                        }
                        ...
                        default:
                                return libiodefv2_error_verbose(LIBIODEFV2_ERROR_IODEFV2_UNKNOWN_TAG, "Unknown tag while readingiodefv2_extension_t: '%u'", tag);
                }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_REFERENCE_URL : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_reference_set_url(reference, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_REFERENCE_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_reference_set_description(reference, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_POSTAL_ADDRESS_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_postal_address_set_description(postal_address, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_NODE_ROLE_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_node_role_set_description(node_role, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_SYSTEM_IMPACT_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_system_impact_set_description(system_impact, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_DISCOVERY_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_discovery_set_description(discovery, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_BUSINESS_IMPACT_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_business_impact_set_description(business_impact, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_EMAIL_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_email_set_description(email, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_SERVICE_NAME_URL : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_service_name_set_url(service_name, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_SERVICE_NAME_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_service_name_set_description(service_name, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_INTENDED_IMPACT_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_intended_impact_set_description(intended_impact, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_SIGNATURE_DATA_SIGNATURE : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_signature_data_set_signature(signature_data, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_EXPECTATION_DEFINED_COA : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_expectation_set_defined_coa(expectation, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_EXPECTATION_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_expectation_set_description(expectation, tmp, -1);
                                break;
                        }
...
int iodefv2_application_header_read(iodefv2_application_header_t *application_header, libiodefv2_msg_t *msg)
{
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_APPLICATION_HEADER_FIELD_TAG: {
                                int ret;
                                iodefv2_application_header_field_t *tmp = NULL;
                                ret = iodefv2_application_header_new_application_header_field(application_header, &tmp, -1);
                                if ( ret < 0 )
                                        return ret;


                                ret = iodefv2_application_header_field_read(tmp, msg);
                                if ( ret < 0 )
                                        return ret;
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_HISTORY_ITEM_DEFINED_COA : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_history_item_set_defined_coa(history_item, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_HISTORY_ITEM_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_history_item_set_description(history_item, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_METHOD_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_method_set_description(method, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_CAMPAIGN_URL : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_campaign_set_url(campaign, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_CAMPAIGN_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_campaign_set_description(campaign, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_CAMPAIGN_CAMPAIGN_ID : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_campaign_set_campaign_id(campaign, tmp, -1);
                                break;
                        }
...
int iodefv2_domain_data_read(iodefv2_domain_data_t *domain_data, libiodefv2_msg_t *msg)
{
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_RELATED_DNS_TAG: {
                                int ret;
                                iodefv2_related_dns_t *tmp = NULL;
                                ret = iodefv2_domain_data_new_related_dns(domain_data, &tmp, -1);
                                if ( ret < 0 )
                                        return ret;


                                ret = iodefv2_related_dns_read(tmp, msg);
                                if ( ret < 0 )
                                        return ret;
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_CONTACT_CONTACT_TITLE : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_contact_set_contact_title(contact, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_CONTACT_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_contact_set_description(contact, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_CONTACT_TAG: {
                                int ret;
                                iodefv2_contact_t *tmp = NULL;
                                ret = iodefv2_contact_new_contact(contact, &tmp, -1);
                                if ( ret < 0 )
                                        return ret;
                        ...
                        case IODEFV2_MSG_CONTACT_CONTACT_NAME : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_contact_set_contact_name(contact, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_ASSESSMENT_INCIDENT_CATEGORY : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_assessment_set_incident_category(assessment, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_ASSESSMENT_MITIGATING_FACTOR : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_assessment_set_mitigating_factor(assessment, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_ASSESSMENT_CAUSE : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_assessment_set_cause(assessment, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_THREAT_ACTOR_URL : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_threat_actor_set_url(threat_actor, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_THREAT_ACTOR_THREAT_ACTOR_ID : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_threat_actor_set_threat_actor_id(threat_actor, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_THREAT_ACTOR_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_threat_actor_set_description(threat_actor, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_RELATED_ACTIVITY_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_related_activity_set_description(related_activity, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_RELATED_ACTIVITY_URL : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_related_activity_set_url(related_activity, tmp, -1);
                                break;
                        }
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_NODE_POSTAL_ADDRESS : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_node_set_postal_address(node, tmp, -1);
                                break;
                        }
...
int iodefv2_hash_read(iodefv2_hash_t *hash, libiodefv2_msg_t *msg)
{
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_APPLICATION_TAG: {
                                int ret;
                                iodefv2_application_t *tmp = NULL;
                                ret = iodefv2_hash_new_application(hash, &tmp);
                                if ( ret < 0 )
                                        return ret;


                                ret = iodefv2_application_read(tmp, msg);
                                if ( ret < 0 )
                                        return ret;
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_APPLICATION_TAG: {
                                int ret;
                                iodefv2_application_t *tmp = NULL;
                                ret = iodefv2_detection_pattern_new_application(detection_pattern, &tmp);
                                if ( ret < 0 )
                                        return ret;
                        ...
                        case IODEFV2_MSG_DETECTION_PATTERN_TAG: {
                                int ret;
                                iodefv2_detection_pattern_t *tmp = NULL;
                                ret = iodefv2_detection_pattern_new_detection_pattern(detection_pattern, &tmp, -1);
                                if ( ret < 0 )
                                        return ret;
                        ...
                        case IODEFV2_MSG_DETECTION_PATTERN_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_detection_pattern_set_description(detection_pattern, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_DETECTION_PATTERN_DETECTION_CONFIGURATION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_detection_pattern_set_detection_configuration(detection_pattern, tmp, -1);
                                break;
                        }
...
int iodefv2_fuzzy_hash_read(iodefv2_fuzzy_hash_t *fuzzy_hash, libiodefv2_msg_t *msg)
{
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_FUZZY_HASH_VALUE_TAG: {
                                int ret;
                                iodefv2_fuzzy_hash_value_t *tmp = NULL;
                                ret = iodefv2_fuzzy_hash_new_fuzzy_hash_value(fuzzy_hash, &tmp, -1);
                                if ( ret < 0 )
                                        return ret;


                                ret = iodefv2_fuzzy_hash_value_read(tmp, msg);
                                if ( ret < 0 )
                                        return ret;
                        ...
                        case IODEFV2_MSG_APPLICATION_TAG: {
                                int ret;
                                iodefv2_application_t *tmp = NULL;
                                ret = iodefv2_fuzzy_hash_new_application(fuzzy_hash, &tmp);
                                if ( ret < 0 )
                                        return ret;
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_EMAIL_DATA_EMAIL_TO : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_email_data_set_email_to(email_data, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_EMAIL_HEADER_FIELD_TAG: {
                                int ret;
                                iodefv2_email_header_field_t *tmp = NULL;
                                ret = iodefv2_email_data_new_email_header_field(email_data, &tmp, -1);
                                if ( ret < 0 )
                                        return ret;


                                ret = iodefv2_email_header_field_read(tmp, msg);
                                if ( ret < 0 )
                                        return ret;
...
int iodefv2_file_read(iodefv2_file_t *file, libiodefv2_msg_t *msg)
{
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_ASSOCIATED_SOFTWARE_TAG: {
                                int ret;
                                iodefv2_associated_software_t *tmp = NULL;
                                ret = iodefv2_file_new_associated_software(file, &tmp);
                                if ( ret < 0 )
                                        return ret;


                                ret = iodefv2_associated_software_read(tmp, msg);
                                if ( ret < 0 )
                                        return ret;
                        ...
                        case IODEFV2_MSG_FILE_URL : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_file_set_url(file, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_FILE_PROPERTIES_TAG: {
                                int ret;
                                iodefv2_file_properties_t *tmp = NULL;
                                ret = iodefv2_file_new_file_properties(file, &tmp, -1);
                                if ( ret < 0 )
                                        return ret;


                                ret = iodefv2_file_properties_read(tmp, msg);
                                if ( ret < 0 )
                                        return ret;
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_APPLICATION_TAG: {
                                int ret;
                                iodefv2_application_t *tmp = NULL;
                                ret = iodefv2_service_new_application(service, &tmp, -1);
                                if ( ret < 0 )
                                        return ret;
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_SYSTEM_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_system_set_description(system, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_SYSTEM_ASSET_ID : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_system_set_asset_id(system, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_OPERATING_SYSTEM_TAG: {
                                int ret;
                                iodefv2_operating_system_t *tmp = NULL;
                                ret = iodefv2_system_new_operating_system(system, &tmp);
                                if ( ret < 0 )
                                        return ret;


                                ret = iodefv2_operating_system_read(tmp, msg);
                                if ( ret < 0 )
                                        return ret;
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_RECORD_DATA_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_record_data_set_description(record_data, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_RECORD_DATA_URL : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_record_data_set_url(record_data, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_APPLICATION_TAG: {
                                int ret;
                                iodefv2_application_t *tmp = NULL;
                                ret = iodefv2_record_data_new_application(record_data, &tmp);
                                if ( ret < 0 )
                                        return ret;
                        ...
                        case IODEFV2_MSG_RECORD_ITEM_TAG: {
                                int ret;
                                iodefv2_record_item_t *tmp = NULL;
                                ret = iodefv2_record_data_new_record_item(record_data, &tmp, -1);
                                if ( ret < 0 )
                                        return ret;


                                ret = iodefv2_record_item_read(tmp, msg);
                                if ( ret < 0 )
                                        return ret;
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_EVENT_DATA_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_event_data_set_description(event_data, tmp, -1);
                                break;
                        }
                        ...
                        case IODEFV2_MSG_EVENT_DATA_TAG: {
                                int ret;
                                iodefv2_event_data_t *tmp = NULL;
                                ret = iodefv2_event_data_new_event_data(event_data, &tmp, -1);
                                if ( ret < 0 )
                                        return ret;
        ...
        while ( 1 ) {
                ...
                switch ( tag ) {
                        ...
                        case IODEFV2_MSG_INCIDENT_DESCRIPTION : {
                                ...
                                if ( ret < 0 )
                                        return ret;
                                iodefv2_incident_set_description(incident, tmp, -1);
                                break;
                        }
