...
#        value = iodefv2.Get("alert.classification.ident")
#        if value:
#               print value

#        value = iodefv2.Get("alert.source(0).ident")
#        if value:
#               print value
...
#        value = iodefv2.Get("alert.classification.reference(0).origin")
#        if value:
#               print value

#        value = iodefv2.Get("alert.classification.reference(0).name")
#        if value:
#               print value
